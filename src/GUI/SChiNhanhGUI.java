 ...
 * @author Phuc Toan
 */
public class SChiNhanhGUI extends javax.swing.JDialog {

    private ChiNhanhBUS cnBUS = new ChiNhanhBUS();
    DefaultTableModel dtmChiNhanh;
    String MaCN;

    public SChiNhanhGUI(String temp) {
        setUndecorated(true);
        ...
        dtmChiNhanh = (DefaultTableModel) tblDSCN.getModel();
        loadDataDSCN();
    }

    public void showAll(ArrayList<ChiNhanhDTO> dscn) {
        dtmChiNhanh.setRowCount(0);
        for (int i = 0; i < dscn.size(); i++) {
            dtmChiNhanh.addRow(new String[]{
                dscn.get(i).getMaCN(),
                dscn.get(i).getTenCN(),
                dscn.get(i).getDiaChi()
            });
        }
    }

    public void loadDataDSCN() {
        cnBUS.docDanhSach3CN();
        ArrayList<ChiNhanhDTO> dscn = cnBUS.getList3ChiNhanh();
        showAll(dscn);
    }

    public String getMaCN() {
        return txtMaCN.getText();
    }
    ...
    private void initComponents() {
        ...
        tblDSCN.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        tblDSCN.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblDSCNMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblDSCN);
        if (tblDSCN.getColumnModel().getColumnCount() > 0) {
            tblDSCN.getColumnModel().getColumn(0).setResizable(false);
            tblDSCN.getColumnModel().getColumn(1).setResizable(false);
            tblDSCN.getColumnModel().getColumn(2).setResizable(false);
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtMaCN, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tblDSCNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDSCNMouseClicked
        int k = tblDSCN.getSelectedRow();
        txtMaCN.setText(tblDSCN.getModel().getValueAt(k, 0).toString());
        txtTenCV.setText(tblDSCN.getModel().getValueAt(k, 1).toString());
        System.out.println(txtMaCN.getText());
    }//GEN-LAST:event_tblDSCNMouseClicked
    ...
    private MyCustom.MyTable tblDSCN;
