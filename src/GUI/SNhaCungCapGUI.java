...
public class SNhaCungCapGUI extends javax.swing.JDialog {
    ...
    /**
     * Creates new form SNhaCungCapGUI
     */
    public SNhaCungCapGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SNhaCungCapGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SNhaCungCapGUI dialog = new SNhaCungCapGUI(new javax.swing.JFrame(), true);
