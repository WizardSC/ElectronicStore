 ...
 * @author Phuc Toan
 */
public class SNhaCungCapGUI extends javax.swing.JDialog {

    String MaCN;
    DefaultTableModel dtmNhaCungCap;
    
    private NhaCungCapBUS nccBUS = new NhaCungCapBUS();
    public SNhaCungCapGUI(String temp) {
        this.MaCN = temp;
        nccBUS.docMaCN(temp);
        setUndecorated(true);
    ...
    private void initComponents() {
        ...
        lblAccount.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/supplier.png"))); // NOI18N
    ...
    private void tblDSNCCMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDSNCCMouseClicked
        ...
        txtTenCV.setText(tblDSNCC.getModel().getValueAt(k, 1).toString());
        System.out.println(txtMaNCC.getText());
    ...
    private MyCustom.MyTable tblDSNCC;
