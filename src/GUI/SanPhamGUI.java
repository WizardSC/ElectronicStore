...
public class SanPhamGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbxDonViTinh.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nam", "Nữ" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cbxDonViTinh, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            ...
                            .addGap(28, 28, 28)
                            .addComponent(txtHo, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(65, 65, 65)
                            .addComponent(jLabel5)
                            .addGap(32, 32, 32)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                    .addComponent(txtMaCV, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
...
//        }
    ...
    private void tblDSSPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDSSPMouseClicked
        ...
        txtMaNV.setText(tblDSSP.getModel().getValueAt(k, 0).toString());
        txtHo.setText(tblDSSP.getModel().getValueAt(k, 1).toString());
        txtTen.setText(tblDSSP.getModel().getValueAt(k, 2).toString());
        txtNamSinh.setText(tblDSSP.getModel().getValueAt(k, 3).toString());

        txtSoDT.setText(tblDSSP.getModel().getValueAt(k, 5).toString());
        txtDiaChi.setText(tblDSSP.getModel().getValueAt(k, 6).toString());
        txtMaCV.setText(tblDSSP.getModel().getValueAt(k, 7).toString());
